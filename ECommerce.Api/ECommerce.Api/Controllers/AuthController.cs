using ECommerce.Application.Features.Commands.Authentications;
using ECommerce.Application.Features.Queries.Authentications.GetUser;
using ECommerce.Application.Models.Authentications;
using ECommerce.Application.Settings.Authentications;
using MediatR;
